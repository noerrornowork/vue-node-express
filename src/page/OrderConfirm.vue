            ...
            <div class="price-count">
              <ul>
                <li>
                  ...
                  <span>{{subtotal | priceFilter('$')}}</span>
                </li>
                <li>
                  <span>Shipping:</span>
                  <span>{{shipping | priceFilter('$')}}</span>
                </li>
                <li>
                  <span>Discount:</span>
                ...
                <li>
                  <span>Tax:</span>
                  <span>{{tax | priceFilter('$')}}</span>
                </li>
                <li class="order-total-price">
                  <span>Order total:</span>
                  <span>{{orderTotal | priceFilter('$')}}</span>
                </li>
              </ul>
            </div>
          </div>
...
<script>
  ...
  import { getCartList, createOrder } from '@/api'
  export default {
    created () {
      this.init()
    ...
    methods: {
      ...
      async payment () {
        let res = await createOrder(this.addressId, this.orderTotal)
        if (res.status === '0') {
          this.$router.push({
            path: '/orderSuccess',
            query: {
